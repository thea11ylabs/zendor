      ...
      <div className="border-t border-zinc-800 p-3">
        <div className="flex gap-2">
          ...
          <button
            ...
            className="px-3 py-2 bg-blue-500 hover:bg-blue-600 disabled:bg-zinc-700 disabled:text-zinc-500 text-white rounded-lg text-sm font-medium transition-colors flex-shrink-0"
          >
